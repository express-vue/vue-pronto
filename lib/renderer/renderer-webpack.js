...
class Renderer {
    ...
    BuildConfig(filePath) {
        return new Promise((resolve, reject) => {
            ...
            const webpackConfig = Object.assign({}, this.webpackConfig);
            webpackConfig.entry = entryPaths;
        ...
        return new Promise((resolve, reject) => {
            ...
            compiler.run((err, stats) => {
                ...
                if (stats.hasErrors()) {
                    ...
                    const serverBundle = mfs.readFileSync(path.join(this.trueRootPath, "dist", "server.js"), "utf-8");
                    const clientBundle = mfs.readFileSync(path.join(this.trueRootPath, "dist", "client.js"), "utf-8");
                ...
                .then(filePath => {
                    this.MakeVueClass(filePath, data)
                        .then(vueClass => {
                            ...
                            const vueStream = vueClass.renderer.renderToStream({});
                            let htmlStream;
                            const layout = Utils.BuildLayout(context);
