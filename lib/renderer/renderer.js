    ...
    FixPlugins(plugins) {
        ...
        if (pluginArray.length > 0) {
            for (let index = 0; index < pluginArray.length; index++) {
                ...
                finalArray.push(new Plugin(element.name, element.options));
            }
        }
                ...
                .then(filePath => {
                    this.MakeVueClass(filePath, data)
                        .then(vueClass => {
                            ...
                            const layout = Utils.BuildLayout(context, vueOptions.plugins);
                ...
                .then(filePath => {
                    this.MakeVueClass(filePath, data)
                        .then(vueClass => {
                            ...
                            let htmlStream;
                            const layout = Utils.BuildLayout(context, plugins);
