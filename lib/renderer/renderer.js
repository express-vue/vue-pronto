...
class Renderer {
    ...
    */
     ...
     * @param {string} filePath 
     * @param {object} data 
     * @returns {Promise<{vue: object, css: string, bundle: Object}>}
     */
     ...
     * @param  {string} vuefile                               - full path to .vue component
     * @param  {Object} data                                  - data to be inserted when generating vue class
     * @param  {{head: Object, template: string, title: string}} vueOptions - vue options to be used when generating head
            ...
            this.MakeVueClass(vuefile, data)
                .then(vueClass => {
                    ...
                    const context = {
                        ...
                        template: vueOptions.template,
                        css: vueClass.css,
                        script: Utils.ScriptToString(vueClass.bundle)
                    };
