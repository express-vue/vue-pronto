...
function BuildScript(script) {
    ...
    let {code} = uglify.minify(vueString, {mangle: false});
    const javaScriptString = `(function(){"use strict";${code}"undefined"!=typeof module&&module.exports?module.exports=createApp:this.app=createApp()}).call(this),${debugToolsString}app.$mount("#app");`;
